...
#
# Generated by export_simulation on Tue Mar 18 17:16:37 -0700 2025
#
################################################################################
...
'-reset_run' switch to the './embsys9.sh' script.

./embsys9.sh -reset_run
...
./embsys9.sh -noclean_files

For more information on the script, please type './embsys9.sh -help'.
