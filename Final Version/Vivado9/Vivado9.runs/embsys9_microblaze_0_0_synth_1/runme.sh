...
HD_PWD='C:/SimpleLock/Vivado9/Vivado9.runs/embsys9_microblaze_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embsys9_microblaze_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embsys9_microblaze_0_0.tcl
