...
HD_PWD='C:/SimpleLock/Vivado9/Vivado9.runs/embsys9_clk_wiz_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embsys9_clk_wiz_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embsys9_clk_wiz_1_1.tcl
