...
HD_PWD='C:/SimpleLock/Vivado9/Vivado9.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log embsys9_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source embsys9_wrapper.tcl -notrace
