...
HD_PWD='C:/SimpleLock/Vivado9/Vivado9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embsys9_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embsys9_wrapper.tcl
