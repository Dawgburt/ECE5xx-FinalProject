...
#et_property -dict { PACKAGE_PIN V14   IOSTANDARD LVCMOS33 } [get_ports { led[13] }]; #IO_L22N_T3_A04_D20_14 Sch=led[13]
...
set_property IOSTANDARD LVCMOS33 [get_ports {fan_out_tri_o[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {led_out_tri_o[0]}]
