...
HD_PWD='C:/SimpleLock/DigitalLockv2/DigitalLockv2.runs/dlembsys_ilmb_v10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dlembsys_ilmb_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dlembsys_ilmb_v10_0.tcl
