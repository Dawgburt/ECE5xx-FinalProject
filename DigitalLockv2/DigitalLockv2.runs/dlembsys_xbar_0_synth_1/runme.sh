...
HD_PWD='C:/SimpleLock/DigitalLockv2/DigitalLockv2.runs/dlembsys_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dlembsys_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dlembsys_xbar_0.tcl
