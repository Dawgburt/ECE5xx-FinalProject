...
HD_PWD='C:/SimpleLock/DigitalLockv2/DigitalLockv2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dlembsys_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dlembsys_wrapper.tcl -notrace
