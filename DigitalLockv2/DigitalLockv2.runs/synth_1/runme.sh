...
HD_PWD='C:/SimpleLock/DigitalLockv2/DigitalLockv2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dlembsys_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dlembsys_wrapper.tcl
