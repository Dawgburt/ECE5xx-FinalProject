...
HD_PWD='C:/SimpleLock/DigitalLockv2/DigitalLockv2.runs/dlembsys_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dlembsys_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dlembsys_lmb_bram_0.tcl
