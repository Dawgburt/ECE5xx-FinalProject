...
@Composable
fun SendPINandLockStatusScreen(navController: NavController, username: String, password: String, userViewModel: UserViewModel){
    //Variables here
    ...
    Column(){
        ...
        Box(
            ...
            Button(
                modifier = Modifier.height(100.dp) .fillMaxWidth() .padding(bottom = 50.dp, start = 16.dp, end = 16.dp), //increase bottom padding for clean display on S25 phone
                ...
                onClick = {
                    ...
                    when{
                        PIN.value.isEmpty() -> {
                            ...
                            //TODO SEND USERNAME, PASSWORD AND PIN VIA MQTT
