...
fun LoginCheckDBSplashScreen() {
    ...
    Column(
        ...
        LaunchedEffect(Unit) {
            ...
            if ((!isUserNameValid.value || !isPasswordValid.value) && mismatchCount.value < 1) { //1 for test purposes, TODO change to 3 after testing
                feedbackMessage.value = "Login Failed"
                mismatchCount.value++
                isError.value = true
            } else if ((!isUserNameValid.value || !isPasswordValid.value) && mismatchCount.value >= 1) { //1 for test purposes, TODO change to 3 after testing
        ...
        if (!loadingDB.value) {
            ...
            LaunchedEffect(isUserNameValid.value, isPasswordValid.value) {
                ...
                //Username or Password Wrong and there were too many attempts
                    ...
                    //TODO I Need a countdown timer here for 30 seconds
                    //TODO the neavigate to the Login Screen
                }
            }
        }
    }
