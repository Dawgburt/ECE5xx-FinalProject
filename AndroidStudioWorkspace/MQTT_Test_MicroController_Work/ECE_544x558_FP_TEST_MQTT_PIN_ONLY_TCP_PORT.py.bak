...
mqtt_client.subscribe('ECE544x558/FP/App/RemoteKey/LockStatus')
...
while True:
    ...
    mqtt_client.publish('nECE544x558/FP/App/RemoteKey/LockStatus', lock_status, qos=1, retain=False) #Qos of 1 for gaurenteed delivery. It unlocks an important door after all
